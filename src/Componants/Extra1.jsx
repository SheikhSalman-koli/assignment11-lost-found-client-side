  ...
  return (
    <div className="w-full bg-[#e8f4f8] p-8 max-w-11/12 mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mb-12">
        ...
        <motion.div whileHover = {{ scale: 1.1 }}  whileTap = {{ scale: 0.8 }} className="p-4 bg-blue-100 rounded-lg">✅ Take clear photos of found items.</motion.div>
        <motion.div whileHover = {{ scale: 1.1 }}  whileTap = {{ scale: 0.8 }} className="p-4 bg-blue-100 rounded-lg">✅ Use platform messaging to communicate.</motion.div>
        <motion.div whileHover = {{ scale: 1.1 }}  whileTap = {{ scale: 0.8 }} className="p-4 bg-blue-100 rounded-lg">✅ Stay safe when meeting someone to exchange items.</motion.div>
      </div>
    </div>
  );
};
